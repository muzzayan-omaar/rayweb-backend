...
exports.update = async (req, res) => {
  try {
    ...
    const pkg = await Package.findByIdAndUpdate(
      req.params.id,
      { name, price, features, collapsible, popular },
